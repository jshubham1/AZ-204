...
export default function App() {
	...
	return (
		<html lang="en">
			...
			<body className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-gray-200">
				<div className="min-h-screen">
					...
					<div className="lg:ml-80">
						...
						<div className="mx-auto max-w-5xl px-4 py-6 lg:px-6 pt-16 lg:pt-6">
							<header className="mb-8 text-center">
								<Link to="/" className="group inline-flex items-center gap-4 no-underline">
									...
									<div className="text-left">
										<h1 className="text-4xl font-bold text-indigo-900 dark:text-indigo-100 group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition-colors">
											AZ-204 Quiz
										</h1>
							...
							<main className="rounded-xl bg-white dark:bg-gray-800 shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
								<div className="p-8">
									<Outlet />
								</div>
							</main>
